...
const BasicDetails = ({ initialData }) => {
  ...
  // Update redux slice whenever formState changes
  useEffect(() => {
            ...
            <Grid size={lay}>
              <FormControl fullWidth variant="outlined">
                ...
                <TextField
                  ...
                  onChange={(e) => handleChange("orderingCustomerName", e.target.value)}
                  InputProps={{ disableUnderline: true }}
                />
              </FormControl>
            </Grid>
            ...
            <Grid size={lay}>
              <FormControl fullWidth variant="outlined">
                ...
                <Select
                  ...
                  onChange={(e) => handleChange("chargesAccountNumber", e.target.value)}
                >
            ...
            <Grid size={lay}>
              <FormControl fullWidth variant="outlined">
                ...
                <TextField
                  ...
                  onChange={(e) => handleChange("leiExpiryDate", e.target.value)}
                  InputProps={{ disableUnderline: true }}
                />
              </FormControl>
            </Grid>
